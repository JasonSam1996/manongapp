package com.jason.manongapp.find.newsimage.ui;
...
public class NewImageViewPager extends BaseAnimCloseViewPager {
    ...
    public NewImageViewPager(Context context) {
        super(context);
    }

    public NewImageViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
