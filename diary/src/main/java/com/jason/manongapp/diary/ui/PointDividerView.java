...
public class PointDividerView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(widthMeasureSpec, (int) mContext.getResources().getDimension(R.dimen.qb_px_10));
    }

    protected void init(Context context, @Nullable AttributeSet attrs) {
        mContext = context;
        mPaint = new Paint();
        radius =  mContext.getResources().getDimension(R.dimen.qb_px_1);
        dividerWidth = mContext.getResources().getDimension(R.dimen.qb_px_6);
    }
