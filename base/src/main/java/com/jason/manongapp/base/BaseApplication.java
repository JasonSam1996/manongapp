...
public class BaseApplication extends Application {
    ...
    private static final String[] MODULESLIST = {
            "com.jason.manongapp.app.APP",
            "com.jason.manongapp.more.app.MoreApplication",
            "com.jason.manongapp.find.app.FindApplication",
            "com.jason.manongapp.index.app.IndexApplication"
    ...
    public void onCreate() {
        ...
        // Module类初始化
        instance = this;
//        Log.i("TAG", "BaseonCreate: ");
        moduleApplicationInit();
        requestBmobInit(this);
        Fresco.initialize(BaseApplication.getInstance());
    }

    private void moduleApplicationInit() {
        for(String moduleImpl : MODULESLIST){
            try {
                Class<?> clazz = Class.forName(moduleImpl);
                Object object = clazz.newInstance();
                if (object instanceof IComponentApplication) {
                    ((IComponentApplication)object).onCreate(BaseApplication.getInstance());
                }
    ...
    private void requestBmobInit(BaseApplication application) {
        headerMaps.put("X-Bmob-Application-Id","3e2c91cb95ceefc5b4ad4da9916d1888");
        headerMaps.put("X-Bmob-REST-API-Key","437139b0987ff441647f635727c93fbf");
